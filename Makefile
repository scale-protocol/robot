localmint:
	...
	spl-token mint 3xJL46KjjDQbPUDg54nEzSC1Ejs49xFHwQJyEMPq7H7g 10000000000000
transfer:
...
investment:
	...
	cargo run investment -p 'ETH/USD' -a 100000000000
	cargo run investment -p 'SOL/USD' -a 100000000000
divestment:
	cargo run divestment -p 'BTC/USD' -a 10000
	cargo run divestment -p 'ETH/USD' -a 5000
	cargo run divestment -p 'SOL/USD' -a 5000
openposition:
	cargo run open_position -p 'BTC/USD' -s 10 -l 2 -t 1 -d 2
closeposition:
